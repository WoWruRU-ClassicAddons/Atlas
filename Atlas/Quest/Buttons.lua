...
function AQInsertQuestInformation()
	...
	if (Quest <= 9) then
		if (Allianceorhorde == 1) then
			OnlyQuestNameRemovedNumber = strsub(getglobal("Inst"..AQINSTANCE.."Quest"..Quest), 4)
		elseif (Allianceorhorde == 2) then
			OnlyQuestNameRemovedNumber = strsub(getglobal("Inst"..AQINSTANCE.."Quest"..Quest.."_HORDE"), 4)
		end
	elseif (Quest > 9) then
		if (Allianceorhorde == 1) then
			OnlyQuestNameRemovedNumber = strsub(getglobal("Inst"..AQINSTANCE.."Quest"..Quest), 5)
		elseif (Allianceorhorde == 2) then
			OnlyQuestNameRemovedNumber = strsub(getglobal("Inst"..AQINSTANCE.."Quest"..Quest.."_HORDE"), 5)
		end
	end
	if ( Allianceorhorde == 1) then
		ChatFrameEditBox:Insert("["..OnlyQuestNameRemovedNumber.."] ["..getglobal("Inst"..AQINSTANCE.."Quest"..AQSHOWNQUEST.."_Level").."]")
	else
		ChatFrameEditBox:Insert("["..OnlyQuestNameRemovedNumber.."] ["..getglobal("Inst"..AQINSTANCE.."Quest"..AQSHOWNQUEST.."_HORDE_Level").."]")
	end
end
...
function AQButton_SetText()
	...
	if ( Allianceorhorde == 1) then
		...
		QuestName:SetText(AQQuestfarbe..getglobal("Inst"..AQINSTANCE.."Quest"..AQSHOWNQUEST))
		QuestLeveltext:SetText(BLUE..AQDiscription_LEVEL..WHITE..getglobal("Inst"..AQINSTANCE.."Quest"..AQSHOWNQUEST.."_Level"))
		QuestAttainLeveltext:SetText(BLUE..AQDiscription_ATTAIN..WHITE..getglobal("Inst"..AQINSTANCE.."Quest"..AQSHOWNQUEST.."_Attain")) 
		Prequesttext:SetText(BLUE..AQDiscription_PREQUEST..WHITE..getglobal("Inst"..AQINSTANCE.."Quest"..AQSHOWNQUEST.."_Prequest").."\n \n"..BLUE..AQDiscription_FOLGEQUEST..WHITE..getglobal("Inst"..AQINSTANCE.."Quest"..AQSHOWNQUEST.."_Folgequest").."\n \n"..BLUE..AQDiscription_START..WHITE..getglobal("Inst"..AQINSTANCE.."Quest"..AQSHOWNQUEST.."_Location").."\n \n"..BLUE..AQDiscription_AIM..WHITE..getglobal("Inst"..AQINSTANCE.."Quest"..AQSHOWNQUEST.."_Aim").."\n \n"..BLUE..AQDiscription_NOTE..WHITE..getglobal("Inst"..AQINSTANCE.."Quest"..AQSHOWNQUEST.."_Note"))
		...
		if ((AtlasORAlphaMap == "AlphaMap") and (getglobal("Inst"..AQINSTANCE.."Quest"..AQSHOWNQUEST.."_Note_AlphaMap") ~= nil)) then
			Prequesttext:SetText(BLUE..AQDiscription_PREQUEST..WHITE..getglobal("Inst"..AQINSTANCE.."Quest"..AQSHOWNQUEST.."_Prequest").."\n \n"..BLUE..AQDiscription_FOLGEQUEST..WHITE..getglobal("Inst"..AQINSTANCE.."Quest"..AQSHOWNQUEST.."_Folgequest").."\n \n"..BLUE..AQDiscription_START..WHITE..getglobal("Inst"..AQINSTANCE.."Quest"..AQSHOWNQUEST.."_Location_AlphaMap").."\n \n"..BLUE..AQDiscription_AIM..WHITE..getglobal("Inst"..AQINSTANCE.."Quest"..AQSHOWNQUEST.."_Aim").."\n \n"..BLUE..AQDiscription_NOTE..WHITE..getglobal("Inst"..AQINSTANCE.."Quest"..AQSHOWNQUEST.."_Note_AlphaMap"))
		end
		
		for b=1, 6 do
			REWARDstext:SetText(getglobal("Inst"..AQINSTANCE.."Quest"..AQSHOWNQUEST.."Rewardtext"))
			if ( getglobal("Inst"..AQINSTANCE.."Quest"..AQSHOWNQUEST.."ID"..b) ~= nil) then
				
				-----------------------------------------------------------------------------
				-- Yay for AutoQuery. Boo for odd variable names.
				-----------------------------------------------------------------------------
				
				SHOWNID = getglobal("Inst"..AQINSTANCE.."Quest"..AQSHOWNQUEST.."ID"..b)
				
				if(AQAutoQuery ~= nil) then
					colour = getglobal("Inst"..AQINSTANCE.."Quest"..AQSHOWNQUEST.."ITC"..b)
					nameDATA = getglobal("Inst"..AQINSTANCE.."Quest"..AQSHOWNQUEST.."name"..b)
	...
	if ( Allianceorhorde == 2) then
		...
		QuestName:SetText(AQQuestfarbe..getglobal("Inst"..AQINSTANCE.."Quest"..AQSHOWNQUEST.."_HORDE"))
		QuestLeveltext:SetText(BLUE..AQDiscription_LEVEL..WHITE..getglobal("Inst"..AQINSTANCE.."Quest"..AQSHOWNQUEST.."_HORDE_Level"))
		QuestAttainLeveltext:SetText(BLUE..AQDiscription_ATTAIN..WHITE..getglobal("Inst"..AQINSTANCE.."Quest"..AQSHOWNQUEST.."_HORDE_Attain"))       
		Prequesttext:SetText(BLUE..AQDiscription_PREQUEST..WHITE..getglobal("Inst"..AQINSTANCE.."Quest"..AQSHOWNQUEST.."_HORDE_Prequest").."\n \n"..BLUE..AQDiscription_FOLGEQUEST..WHITE..getglobal("Inst"..AQINSTANCE.."Quest"..AQSHOWNQUEST.."_HORDE_Folgequest").."\n \n"..BLUE..AQDiscription_START..WHITE..getglobal("Inst"..AQINSTANCE.."Quest"..AQSHOWNQUEST.."_HORDE_Location").."\n \n"..BLUE..AQDiscription_AIM..WHITE..getglobal("Inst"..AQINSTANCE.."Quest"..AQSHOWNQUEST.."_HORDE_Aim").."\n \n"..BLUE..AQDiscription_NOTE..WHITE..getglobal("Inst"..AQINSTANCE.."Quest"..AQSHOWNQUEST.."_HORDE_Note"))
		...
		if ((AtlasORAlphaMap == "AlphaMap") and (getglobal("Inst"..AQINSTANCE.."Quest"..AQSHOWNQUEST.."_HORDE_Note_AlphaMap") ~= nil)) then
			Prequesttext:SetText(BLUE..AQDiscription_PREQUEST..WHITE..getglobal("Inst"..AQINSTANCE.."Quest"..AQSHOWNQUEST.."_HORDE_Prequest").."\n \n"..BLUE..AQDiscription_FOLGEQUEST..WHITE..getglobal("Inst"..AQINSTANCE.."Quest"..AQSHOWNQUEST.."_HORDE_Folgequest").."\n \n"..BLUE..AQDiscription_START..WHITE..getglobal("Inst"..AQINSTANCE.."Quest"..AQSHOWNQUEST.."_HORDE_Location_AlphaMap").."\n \n"..BLUE..AQDiscription_AIM..WHITE..getglobal("Inst"..AQINSTANCE.."Quest"..AQSHOWNQUEST.."_HORDE_Aim").."\n \n"..BLUE..AQDiscription_NOTE..WHITE..getglobal("Inst"..AQINSTANCE.."Quest"..AQSHOWNQUEST.."_HORDE_Note_AlphaMap"))
		end
		for b=1, 6 do
			REWARDstext:SetText(getglobal("Inst"..AQINSTANCE.."Quest"..AQSHOWNQUEST.."Rewardtext_HORDE"))
			if ( getglobal("Inst"..AQINSTANCE.."Quest"..AQSHOWNQUEST.."ID"..b.."_HORDE") ~= nil) then
				
				-----------------------------------------------------------------------------
				-- Yay for AutoQuery. Boo for odd variable names.
				-----------------------------------------------------------------------------
				
				SHOWNID = getglobal("Inst"..AQINSTANCE.."Quest"..AQSHOWNQUEST.."ID"..b.."_HORDE")
				
				if(AQAutoQuery ~= nil) then
					colour = getglobal("Inst"..AQINSTANCE.."Quest"..AQSHOWNQUEST.."ITC"..b.."_HORDE")
					nameDATA = getglobal("Inst"..AQINSTANCE.."Quest"..AQSHOWNQUEST.."name"..b.."_HORDE")
...
function AQgetItemInformation(count,what)
	...
	if ( Allianceorhorde == 2) then
		itemId = getglobal("Inst"..AQINSTANCE.."Quest"..AQSHOWNQUEST.."ID"..count.."_HORDE")
		itemdiscription = getglobal("Inst"..AQINSTANCE.."Quest"..AQSHOWNQUEST.."description"..count.."_HORDE")
		itemTEXTSAVED = getglobal("Inst"..AQINSTANCE.."Quest"..AQSHOWNQUEST.."ITC"..count.."_HORDE")..getglobal("Inst"..AQINSTANCE.."Quest"..AQSHOWNQUEST.."name"..count.."_HORDE")
	else
		itemId = getglobal("Inst"..AQINSTANCE.."Quest"..AQSHOWNQUEST.."ID"..count)
		itemdiscription = getglobal("Inst"..AQINSTANCE.."Quest"..AQSHOWNQUEST.."description"..count)
		itemTEXTSAVED = getglobal("Inst"..AQINSTANCE.."Quest"..AQSHOWNQUEST.."ITC"..count)..getglobal("Inst"..AQINSTANCE.."Quest"..AQSHOWNQUEST.."name"..count)
	end
...
function AQColourCheck(arg1)
	local AQQuestlevelf
	if (arg1 == 1) then
		AQQuestlevelf = tonumber(getglobal("Inst"..AQINSTANCE.."Quest"..AQSHOWNQUEST.."_Level"))
		--DEFAULT_CHAT_FRAME:AddMessage("BLA")
	else
		AQQuestlevelf = tonumber(getglobal("Inst"..AQINSTANCE.."Quest"..AQSHOWNQUEST.."_HORDE_Level"))
...
function AQExtendedPages()
	...
	if ( Allianceorhorde == 1) then --Alliance
		SHIT = getglobal("Inst"..AQINSTANCE.."Quest"..AQSHOWNQUEST.."_Page")
	else
		SHIT = getglobal("Inst"..AQINSTANCE.."Quest"..AQSHOWNQUEST.."_HORDE_Page")
	end
...
function AQButtonSTORY_SetText()
	...
	if (getglobal("Inst"..AQINSTANCE.."Story") ~= nil) then
		QuestName:SetText(BLUE..getglobal("Inst"..AQINSTANCE.."Caption"))
		if (type(getglobal("Inst"..AQINSTANCE.."Story")) == "table") then
			StoryTEXT:SetText(WHITE..getglobal("Inst"..AQINSTANCE.."Story")["Page1"])
			-- Show Next side button if next site is avaiable
			if (getglobal("Inst"..AQINSTANCE.."Story")["Page2"] ~= nil) then
				ShowUIPanel(AQNextPageButton_Right)
				AQ_CurrentSide = 1
				-- shows total amount of pages
				AQPageCount:SetText(AQ_CurrentSide.."/"..getglobal("Inst"..AQINSTANCE.."Story")["MaxPages"])
				-- count to make a diffrent between story and normal text
				AQ_NextPageCount = "Story"
			end
		elseif (type(getglobal("Inst"..AQINSTANCE.."Story")) == "string") then
			StoryTEXT:SetText(WHITE..getglobal("Inst"..AQINSTANCE.."Story"))
		end
		-- added to work with future versions of atlas (before i update e.g. before you dl the update)
	elseif (getglobal("Inst"..AQINSTANCE.."Story") == nil) then
...
function AQNextPageR_OnClick()
	...
	if (AQ_NextPageCount == "Story" ) then
		StoryTEXT:SetText(WHITE..getglobal("Inst"..AQINSTANCE.."Story")["Page"..AQ_CurrentSide])
		AQPageCount:SetText(AQ_CurrentSide.."/"..getglobal("Inst"..AQINSTANCE.."Story")["MaxPages"])
		if (getglobal("Inst"..AQINSTANCE.."Caption"..AQ_CurrentSide) ~= nil) then
			QuestName:SetText(BLUE..getglobal("Inst"..AQINSTANCE.."Caption"..AQ_CurrentSide))
		else
			QuestName:SetText(BLUE..getglobal("Inst"..AQINSTANCE.."Caption"))
		end
		-- hide button if no next side
		if (getglobal("Inst"..AQINSTANCE.."Story")["Page"..SideAfterThis] == nil) then
			HideUIPanel(AQNextPageButton_Right)
		else
			ShowUIPanel(AQNextPageButton_Right)
		end
	...
	if (AQ_NextPageCount == "Boss" ) then
		QuestName:SetText(BLUE..getglobal("Inst"..AQINSTANCE.."General")[AQ_CurrentSide][1])
		StoryTEXT:SetText(WHITE..getglobal("Inst"..AQINSTANCE.."General")[AQ_CurrentSide][2].."\n \n"..getglobal("Inst"..AQINSTANCE.."General")[AQ_CurrentSide][3])
		-- Show Next side button if next site is avaiable
		if (getglobal("Inst"..AQINSTANCE.."General")[SideAfterThis] ~= nil) then
			ShowUIPanel(AQNextPageButton_Right)
		end
		-- shows total amount of pages
		AQPageCount:SetText(AQ_CurrentSide.."/"..getn(getglobal("Inst"..AQINSTANCE.."General")))
	end
...
function AQGeneral_OnClick(arg1)
	...
	--
	if (getglobal("Inst"..AQINSTANCE.."General") ~= nil) then
		QuestName:SetText(BLUE..getglobal("Inst"..AQINSTANCE.."General")[1][1])
		StoryTEXT:SetText(WHITE..getglobal("Inst"..AQINSTANCE.."General")[1][2].."\n \n"..getglobal("Inst"..AQINSTANCE.."General")[1][3])
		-- Show Next side button if next site is avaiable
		AQ_NextPageCount = "Boss"
		if (getglobal("Inst"..AQINSTANCE.."General")[2] ~= nil) then
			ShowUIPanel(AQNextPageButton_Right)
			AQ_CurrentSide = 1
			-- shows total amount of pages
			AQPageCount:SetText(AQ_CurrentSide.."/"..getn(getglobal("Inst"..AQINSTANCE.."General")))
