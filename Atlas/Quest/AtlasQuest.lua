...
function atlasquest_command(param)
	...
	if (param == "help") then
		...
		ChatFrame1:AddMessage(RED..getglobal("Inst"..AQINSTANCE.."Caption"))
		ChatFrame1:AddMessage(GREY..getglobal("Inst"..AQINSTANCE.."QAA"))
		for q=1,20 do
			ChatFrame1:AddMessage(Orange..getglobal("Inst"..AQINSTANCE.."Quest"..q))
		end
		--List of Horde Quests
		elseif (param == "inst h") then
		ChatFrame1:AddMessage(RED..getglobal("Inst"..AQINSTANCE.."Caption"))
		ChatFrame1:AddMessage(GREY..getglobal("Inst"..AQINSTANCE.."QAH"))
		for q=1,20 do
			ChatFrame1:AddMessage(Orange..getglobal("Inst"..AQINSTANCE.."Quest"..q.."_HORDE"))
		end
		...
		--Alliance
		ChatFrame1:AddMessage(ORANGE.."Alliance Quest: "..getglobal("Inst"..AQINSTANCE.."Quest"..param))
		ChatFrame1:AddMessage("Level: "..getglobal("Inst"..AQINSTANCE.."Quest"..param.."_Level"))
		ChatFrame1:AddMessage("Attain: "..getglobal("Inst"..AQINSTANCE.."Quest"..param.."_Attain"))
		ChatFrame1:AddMessage("Goal: "..getglobal("Inst"..AQINSTANCE.."Quest"..param.."_Aim"))
		ChatFrame1:AddMessage("Start: "..getglobal("Inst"..AQINSTANCE.."Quest"..param.."_Location"))
		ChatFrame1:AddMessage("Note: "..getglobal("Inst"..AQINSTANCE.."Quest"..param.."_Note"))
		ChatFrame1:AddMessage("Prequest: "..getglobal("Inst"..AQINSTANCE.."Quest"..param.."_Prequest"))
		ChatFrame1:AddMessage("Postquest: "..getglobal("Inst"..AQINSTANCE.."Quest"..param.."_Folgequest"))
		
		--Horde
		ChatFrame1:AddMessage(ORANGE.."Horde Quest: "..getglobal("Inst"..AQINSTANCE.."Quest"..param.."_HORDE"))
		ChatFrame1:AddMessage("Level: "..getglobal("Inst"..AQINSTANCE.."Quest"..param.."_HORDE_Level"))
		ChatFrame1:AddMessage("Attain: "..getglobal("Inst"..AQINSTANCE.."Quest"..param.."_HORDE_Attain"))
		ChatFrame1:AddMessage("Goal: "..getglobal("Inst"..AQINSTANCE.."Quest"..param.."_HORDE_Aim"))
		ChatFrame1:AddMessage("Start: "..getglobal("Inst"..AQINSTANCE.."Quest"..param.."_HORDE_Location"))
		ChatFrame1:AddMessage("Note: "..getglobal("Inst"..AQINSTANCE.."Quest"..param.."_HORDE_Note"))
		ChatFrame1:AddMessage("Prequest: "..getglobal("Inst"..AQINSTANCE.."Quest"..param.."_HORDE_Prequest"))
		ChatFrame1:AddMessage("Postquest: "..getglobal("Inst"..AQINSTANCE.."Quest"..param.."_HORDE_Folgequest"))
	end
end
...
function AQ_SetCaption()
    ...
    if (getglobal("Inst"..AQINSTANCE.."Caption") ~= nil) then
		Ueberschriftborder:SetText(getglobal("Inst"..AQINSTANCE.."Caption"))
	end
end
...
function AtlasQuestSetTextandButtons()
	...
	if (Allianceorhorde == 1) then
		...
		if (getglobal("Inst"..AQINSTANCE.."QAA") ~= nil) then
			AtlasQuestAnzahl:SetText(getglobal("Inst"..AQINSTANCE.."QAA"))
			else
			AtlasQuestAnzahl:SetText("")
		end
		for b=1, AQMAXQUESTS do
			if (getglobal("Inst"..AQINSTANCE.."Quest"..b.."FQuest")) then
                getglobal("AQQuestlineArrow_"..b):SetTexture("Interface\\Glues\\Login\\UI-BackArrow")
                getglobal("AQQuestlineArrow_"..b):Show()
				elseif (getglobal("Inst"..AQINSTANCE.."Quest"..b.."PreQuest")) then
			...
			AQQuestlevelf = tonumber(getglobal("Inst"..AQINSTANCE.."Quest"..b.."_Level"))
			if (getglobal("Inst"..AQINSTANCE.."Quest"..b) ~= nil) then
                ...
                getglobal("AQBUTTONTEXT"..b):SetText(AQQuestfarbe..getglobal("Inst"..AQINSTANCE.."Quest"..b))
				else
	...
	if (Allianceorhorde == 2) then
		AQINSTATM = AQINSTANCE
		if (getglobal("Inst"..AQINSTANCE.."QAH") ~= nil) then
			AtlasQuestAnzahl:SetText(getglobal("Inst"..AQINSTANCE.."QAH"))
			else
			AtlasQuestAnzahl:SetText("")
		end
		for b=1, AQMAXQUESTS do
			if (getglobal("Inst"..AQINSTANCE.."Quest"..b.."FQuest_HORDE")) then
                getglobal("AQQuestlineArrow_"..b):SetTexture("Interface\\Glues\\Login\\UI-BackArrow")
                getglobal("AQQuestlineArrow_"..b):Show()
				elseif (getglobal("Inst"..AQINSTANCE.."Quest"..b.."PreQuest_HORDE")) then
                getglobal("AQQuestlineArrow_"..b):SetTexture("Interface\\GossipFrame\\PetitionGossipIcon")
                getglobal("AQQuestlineArrow_"..b):Show()
				else
                getglobal("AQQuestlineArrow_"..b):Hide()
			...
			if (getglobal("Inst"..AQINSTANCE.."Quest"..b.."_HORDE") ~= nil) then
                AQQuestlevelf = tonumber(getglobal("Inst"..AQINSTANCE.."Quest"..b.."_HORDE_Level"))
                if ( AQQuestlevelf ~= nil or AQQuestlevelf ~= 0 or AQQuestlevelf ~= "") then
					if ( AQQuestlevelf == UnitLevel("player") or AQQuestlevelf == UnitLevel("player") + 2 or AQQuestlevelf  == UnitLevel("player") - 2 or AQQuestlevelf == UnitLevel("player") + 1 or AQQuestlevelf  == UnitLevel("player") - 1) then
						AQQuestfarbe = Gelb
						elseif ( AQQuestlevelf > UnitLevel("player") + 2 and AQQuestlevelf <= UnitLevel("player") + 4) then
                ...
                getglobal("AQQuestbutton"..b):Enable()
                getglobal("AQBUTTONTEXT"..b):SetText(AQQuestfarbe..getglobal("Inst"..AQINSTANCE.."Quest"..b.."_HORDE"))
				else
                getglobal("AQQuestbutton"..b):Disable()
                getglobal("AQBUTTONTEXT"..b):SetText()
			end
...
function AtlasQuestItem_OnEnter()
	...
	if ( Allianceorhorde == 1) then
		SHOWNID = getglobal("Inst"..AQINSTANCE.."Quest"..AQSHOWNQUEST.."ID"..AQTHISISSHOWN)
		colour = getglobal("Inst"..AQINSTANCE.."Quest"..AQSHOWNQUEST.."ITC"..AQTHISISSHOWN)
		nameDATA = getglobal("Inst"..AQINSTANCE.."Quest"..AQSHOWNQUEST.."name"..AQTHISISSHOWN)
		else
		SHOWNID = getglobal("Inst"..AQINSTANCE.."Quest"..AQSHOWNQUEST.."ID"..AQTHISISSHOWN.."_HORDE")
		colour = getglobal("Inst"..AQINSTANCE.."Quest"..AQSHOWNQUEST.."ITC"..AQTHISISSHOWN.."_HORDE")
		nameDATA = getglobal("Inst"..AQINSTANCE.."Quest"..AQSHOWNQUEST.."name"..AQTHISISSHOWN.."_HORDE")
	end
